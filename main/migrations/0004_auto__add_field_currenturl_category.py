...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CurrentUrl.category'
        db.add_column(u'main_currenturl', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CurrentUrl.category'
        db.delete_column(u'main_currenturl', 'category_id')
