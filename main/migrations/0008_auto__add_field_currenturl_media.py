...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CurrentUrl.media'
        db.add_column(u'main_currenturl', 'media',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Media'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CurrentUrl.media'
        db.delete_column(u'main_currenturl', 'media_id')
